...
export const BottomTabNav = () => {
  ...
  const tabItems = [
    { icon: "/icons/home.svg", label: "Explore", path: "/" },
    { icon: "/icons/trips.svg", label: "My Trips", path: "/trips" },
    { icon: "/icons/add-new.svg", label: "Add Trip", path: "/preferences" },
    {
        ...
        {showProfileDropdown && (
          <div className="profile-dropdown" ref={dropdownRef}>
            ...
            <div className="project-footer">
              <p>Thanks for checking out PickAPark!</p>
            </div>
          </div>
        )}
      </div>
